...
- Coordinator-owned commits are allowed only at approved checkpoints: after
  ...
  edits plus quick verification before configured final review, and after the
  configured final review/fix phase (or its explicit skip) plus final
  verification. Coordinator-owned temporary scratch refs under
