...
require_contains "README.md" 'run `/clear` first' "README documents the fresh-session /clear flow"
require_contains "README.md" "implementation handoff to use" "README documents the post-plan handoff choice"
require_contains "README.md" "both commands" "README documents both implementation handoff commands"
require_contains "README.md" "current Codex context usage" "README documents current Codex context usage"
require_contains "README.md" "55%" "README documents the 55 percent routing threshold"
require_contains "README.md" "saved plan size" "README documents the saved plan-size fallback"
...
require_contains "docs/README.codex.md" 'Run `/clear` first' "Codex install guide documents the fresh-session /clear flow"
require_contains "docs/README.codex.md" "implementation handoff to use" "Codex install guide documents the post-plan handoff choice"
require_contains "docs/README.codex.md" "still shows both" "Codex install guide documents both implementation handoff commands"
require_contains "docs/README.codex.md" "current Codex context usage" "Codex install guide documents current Codex context usage"
require_contains "docs/README.codex.md" "55%" "Codex install guide documents the 55 percent routing threshold"
require_contains "docs/README.codex.md" "saved plan size" "Codex install guide documents the saved plan-size fallback"
...
require_contains "skills/writing-plans/SKILL.md" "Context-Size Handoff" "writing-plans requires Context-Size Handoff"
...
require_file "skills/writing-plans/current-session-context.md" "writing-plans current session context helper exists"
require_contains "skills/writing-plans/current-session-context.md" "Current Session Context Measurement" "writing-plans helper measures current session context"
require_contains "skills/writing-plans/current-session-context.md" "CODEX_THREAD_ID" "writing-plans helper uses CODEX_THREAD_ID"
require_contains "skills/writing-plans/current-session-context.md" '${CODEX_HOME:-$HOME/.codex}/sessions/YYYY/MM/DD/rollout-*.jsonl' "writing-plans helper reads session rollouts from the codex session path"
require_contains "skills/writing-plans/current-session-context.md" "model_context_window" "writing-plans helper inspects model_context_window"
require_contains "skills/writing-plans/current-session-context.md" "cached_input_tokens" "writing-plans helper inspects cached_input_tokens"
require_contains "skills/writing-plans/current-session-context.md" "55" "writing-plans helper uses the 55 percent routing threshold"
require_contains "skills/writing-plans/current-session-context.md" 'wc -c "$PLAN_PATH"' "writing-plans helper falls back to saved plan sizing"
...
require_contains "skills/writing-plans/SKILL.md" "/clear" "writing-plans shows the fresh-session /clear commands"
...
require_contains "skills/writing-plans/SKILL.md" "skills/writing-plans/current-session-context.md" "writing-plans references the current session context helper"
require_contains "skills/writing-plans/SKILL.md" "CODEX_THREAD_ID" "writing-plans uses CODEX_THREAD_ID for current context routing"
require_contains "skills/writing-plans/SKILL.md" "55%" "writing-plans routes at the 55 percent threshold"
require_contains "skills/writing-plans/SKILL.md" 'wc -c "$PLAN_PATH"' "writing-plans keeps the saved plan-size fallback"
require_contains "skills/writing-plans/SKILL.md" "35840" "writing-plans preserves the saved plan-size threshold"
require_contains "skills/writing-plans/SKILL.md" "Always show both implementation handoff commands" "writing-plans always shows both handoff commands"
require_contains "skills/writing-plans/SKILL.md" "ask the user which implementation handoff to use" "writing-plans asks for the implementation handoff choice"
require_contains "skills/writing-plans/SKILL.md" "coordinator creates the accepted plan checkpoint commit" "writing-plans asks after the accepted plan checkpoint"
require_contains "skills/writing-plans/SKILL.md" "implementation handoff choice" "writing-plans names the implementation handoff choice"
require_contains "skills/writing-plans/SKILL.md" "Run after /clear (Recommended)" "writing-plans can mark /clear as the recommended handoff"
require_contains "skills/writing-plans/SKILL.md" "Continue in current session (Recommended)" "writing-plans can mark current session as the recommended handoff"
require_not_contains "skills/writing-plans/SKILL.md" 'wc -c "$PLAN_PATH" decides the recommended implementation handoff' "writing-plans rejects old plan-size-primary handoff wording"
...
require_contains "skills/writing-plans/SKILL.md" "approve both the reviewed" "writing-plans asks for reviewed plan approval"
require_contains "skills/writing-plans/SKILL.md" "plan and model/task allocation" "writing-plans asks for model/task allocation approval"
...
require_contains "skills/writing-plans/plan-document-reviewer-prompt.md" "current-session context pct" "plan reviewer checks the current-session context percentage"
require_contains "skills/writing-plans/plan-document-reviewer-prompt.md" "55%" "plan reviewer checks the 55 percent routing threshold"
require_contains "skills/writing-plans/plan-document-reviewer-prompt.md" "current-session-context.md" "plan reviewer checks the current session context helper"
require_contains "skills/writing-plans/plan-document-reviewer-prompt.md" "wc -c" "plan reviewer checks the saved plan-size fallback"
require_contains "skills/writing-plans/plan-document-reviewer-prompt.md" "35840" "plan reviewer checks the saved plan-size threshold"
require_contains "skills/writing-plans/plan-document-reviewer-prompt.md" "Commit Policy" "plan reviewer checks commit policy"
require_contains "skills/writing-plans/plan-document-reviewer-prompt.md" "Context Handoff" "plan reviewer checks context handoff"
require_contains "skills/writing-plans/plan-document-reviewer-prompt.md" "asking the user which implementation handoff to use after the accepted plan checkpoint commit" "plan reviewer checks the post-plan handoff ask"
require_contains "skills/writing-plans/plan-document-reviewer-prompt.md" 'always shows both current-session and `/clear` commands' "plan reviewer checks both handoff commands are shown"
