...
require_not_contains "README.md" "Simple Power uses two configurable model ""tiers" "README no longer documents only two model tiers"
...
require_contains "docs/README.codex.md" "Use FAST for obvious repetitive work" "Codex install guide documents FAST as repetitive work"
require_not_contains "docs/README.codex.md" "Simple Power uses two configurable model ""tiers" "Codex install guide no longer documents only two model tiers"
...
require_contains "skills/writing-plans/SKILL.md" "FAST/NORMAL/BEST" "writing-plans documents three-tier allocation"
...
require_contains "skills/writing-plans/plan-document-reviewer-prompt.md" "FAST, NORMAL, or BEST" "plan reviewer checks three-tier model allocation"
...
require_contains "skills/subagent-driven-development/SKILL.md" "FAST, NORMAL, or BEST" "SDD documents three-tier model allocation"
...
require_contains "skills/using-simplepower/references/codex-tools.md" "FAST_or_NORMAL_or_BEST" "Codex tool mapping documents three-tier worker dispatch"
