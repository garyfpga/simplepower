...
require_contains "README.md" "SIMPLEPOWER_FAST_MODEL=\"gpt-5.3-codex-spark-high\"" "README documents the FAST Spark model env var"
require_contains "README.md" "FAST is the Spark tier" "README documents FAST as the Spark tier"
require_contains "README.md" "four configurable model tiers" "README documents four model tiers"
require_contains "README.md" "REVIEW is for the plan reviewer and final review+fix agent" "README documents REVIEW for review roles"
require_contains "README.md" "feature/<slug>" "README documents the default brainstorming branch"
require_contains "README.md" "debug/<slug>" "README documents the default debugging branch"
require_contains "README.md" "git checkout -b" "README documents in-place branch creation"
require_contains "README.md" "before invoking simplepower:writing-plans" "README documents the brainstorming planning handoff gate"
require_contains "README.md" "before dispatching the REVIEW-tier plan reviewer" "README documents the writing-plans reviewer gate"
require_contains "README.md" "assignment in project root" "README documents project-root AGENTS precedence"
require_contains "README.md" "nested AGENTS" "README blocks nested AGENTS scanning"
require_contains "README.md" "repo-wide grep are not part of this feature" "README blocks repo-wide AGENTS grep"
...
require_contains "docs/README.codex.md" "SIMPLEPOWER_REVIEW_MODEL=\"gpt-5.5-xhigh\"" "Codex install guide documents the REVIEW model env var"
require_contains "docs/README.codex.md" "SIMPLEPOWER_NORMAL_MODEL=\"gpt-5.4-mini-high\"" "Codex install guide documents the NORMAL model env var"
require_contains "docs/README.codex.md" "SIMPLEPOWER_FAST_MODEL=\"gpt-5.3-codex-spark-high\"" "Codex install guide documents the FAST Spark model env var"
...
require_contains "docs/README.codex.md" "four configurable model tiers" "Codex install guide documents four model tiers"
require_contains "docs/README.codex.md" "one REVIEW-tier review+fix pass" "Codex install guide documents the REVIEW-tier review+fix pass"
require_contains "docs/README.codex.md" "Use REVIEW for the plan reviewer and final review+fix agent" "Codex install guide documents REVIEW for review roles"
require_contains "docs/README.codex.md" "feature/<slug>" "Codex install guide documents the default brainstorming branch"
require_contains "docs/README.codex.md" "debug/<slug>" "Codex install guide documents the default debugging branch"
require_contains "docs/README.codex.md" "git checkout -b" "Codex install guide documents in-place branch creation"
require_contains "docs/README.codex.md" "before invoking simplepower:writing-plans" "Codex install guide documents the brainstorming planning handoff gate"
require_contains "docs/README.codex.md" "before dispatching the REVIEW-tier plan reviewer" "Codex install guide documents the writing-plans reviewer gate"
require_contains "docs/README.codex.md" "assignment in project root" "Codex install guide documents project-root AGENTS precedence"
require_contains "docs/README.codex.md" "nested AGENTS" "Codex install guide blocks nested AGENTS scanning"
require_contains "docs/README.codex.md" "repo-wide grep are not part of this feature" "Codex install guide blocks repo-wide AGENTS grep"
...
require_contains "docs/testing.md" "feature/<slug>" "testing docs cover the default brainstorming branch"
require_contains "docs/testing.md" "debug/<slug>" "testing docs cover the default debugging branch"
require_contains "docs/testing.md" "Before invoking simplepower:writing-plans" "testing docs cover the brainstorming planning handoff gate"
require_contains "docs/testing.md" "Before dispatching the REVIEW-tier plan reviewer" "testing docs cover the writing-plans reviewer gate"
...
require_contains "skills/writing-plans/SKILL.md" "SIMPLEPOWER_FAST_MODEL=\"gpt-5.3-codex-spark-high\"" "writing-plans defaults FAST to Spark high"
...
require_contains "skills/writing-plans/SKILL.md" "project root AGENTS.md" "writing-plans documents project-root AGENTS precedence"
require_contains "skills/writing-plans/SKILL.md" "nested AGENTS.md files or repo-wide grep" "writing-plans blocks nested AGENTS scanning"
require_contains "skills/writing-plans/SKILL.md" "Do not run Codex CLI" "writing-plans reviewer dispatch forbids Codex CLI"
...
require_contains "skills/writing-plans/SKILL.md" "before dispatching the REVIEW-tier plan reviewer" "writing-plans asks before dispatching the reviewer"
require_contains "skills/writing-plans/SKILL.md" "immediate current-session execution" "writing-plans preserves combined approval before implementation"
...
require_contains "skills/writing-plans/plan-document-reviewer-prompt.md" "quick verifier uses the FAST tier by default" "plan reviewer checks quick verifier FAST routing"
...
require_contains "skills/writing-plans/plan-document-reviewer-prompt.md" "project root AGENTS.md" "plan reviewer checks project-root AGENTS precedence"
require_contains "skills/writing-plans/plan-document-reviewer-prompt.md" "no nested AGENTS.md scan and no repo-wide grep" "plan reviewer checks no nested AGENTS scanning"
...
require_contains "skills/brainstorming/SKILL.md" "feature/<slug>" "brainstorming documents the default feature branch"
require_contains "skills/brainstorming/SKILL.md" "lowercased, dash-separated, and short" "brainstorming documents branch slug formatting"
require_contains "skills/brainstorming/SKILL.md" "avoid sensitive names" "brainstorming avoids sensitive branch slugs"
require_contains "skills/brainstorming/SKILL.md" "git checkout -b" "brainstorming documents in-place branch creation"
require_contains "skills/brainstorming/SKILL.md" "worktrees are not the default" "brainstorming documents that worktrees are not the default"
require_contains "skills/brainstorming/SKILL.md" "continue in the current checkout" "brainstorming requires user approval after branch failure"
require_contains "skills/brainstorming/SKILL.md" "explicitly approves continuing" "brainstorming blocks substantive work after branch failure until approval"
require_contains "skills/brainstorming/SKILL.md" "before invoking simplepower:writing-plans" "brainstorming asks before handing off to writing-plans"
...
require_contains "skills/subagent-driven-development/SKILL.md" "SIMPLEPOWER_FAST_MODEL=\"gpt-5.3-codex-spark-high\"" "SDD defaults FAST to Spark high"
...
require_contains "skills/subagent-driven-development/SKILL.md" "project root AGENTS.md" "SDD documents project-root AGENTS precedence"
require_contains "skills/subagent-driven-development/SKILL.md" "must not scan" "SDD blocks nested AGENTS scanning"
...
require_contains "skills/systematic-debugging/SKILL.md" "debug/<slug>" "systematic-debugging documents the default debug branch"
require_contains "skills/systematic-debugging/SKILL.md" "lowercased, dash-separated, and short" "systematic-debugging documents branch slug formatting"
require_contains "skills/systematic-debugging/SKILL.md" "avoid sensitive names" "systematic-debugging avoids sensitive branch slugs"
require_contains "skills/systematic-debugging/SKILL.md" "git checkout -b" "systematic-debugging documents in-place branch creation"
require_contains "skills/systematic-debugging/SKILL.md" "worktrees are not the default" "systematic-debugging documents that worktrees are not the default"
require_contains "skills/systematic-debugging/SKILL.md" "continue in the current checkout" "systematic-debugging requires user approval after branch failure"
require_contains "skills/systematic-debugging/SKILL.md" "explicitly approves continuing" "systematic-debugging blocks substantive work after branch failure until approval"
...
require_contains "skills/using-simplepower/references/codex-tools.md" "quoted assignment in project root" "Codex tool mapping documents project-root AGENTS precedence"
require_contains "skills/using-simplepower/references/codex-tools.md" "nested AGENTS files and" "Codex tool mapping blocks nested AGENTS scanning"
...
require_contains "skills/using-simplepower/references/codex-tools.md" "Always dispatch the plan reviewer and review+fix agent with REVIEW" "Codex tool mapping routes review roles through REVIEW"
require_contains "skills/using-simplepower/references/codex-tools.md" "SIMPLEPOWER_FAST_MODEL=\"gpt-5.3-codex-spark-high\"" "Codex tool mapping defaults FAST to Spark high"
require_contains "skills/using-simplepower/references/codex-tools.md" "quick verifier" "Codex tool mapping includes the quick verifier"
require_contains "skills/using-simplepower/references/codex-tools.md" "Default resolves to Spark high" "Codex tool mapping describes the quick verifier FAST default"
